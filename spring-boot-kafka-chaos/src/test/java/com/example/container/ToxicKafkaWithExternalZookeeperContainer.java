...
public class ToxicKafkaWithExternalZookeeperContainer extends KafkaContainer {

	private List<Supplier<String>> listeners = new ArrayList<>();

	public ToxicKafkaWithExternalZookeeperContainer(String image) {
	...
	public ToxicKafkaWithExternalZookeeperContainer withAdditionalListener(Supplier<String> listener) {
