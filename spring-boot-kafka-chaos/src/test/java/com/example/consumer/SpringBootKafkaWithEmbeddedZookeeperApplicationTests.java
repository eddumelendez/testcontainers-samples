...
import com.example.container.ToxicKafkaWithEmbeddedZookeeperContainer;
...
@Testcontainers
class SpringBootKafkaWithEmbeddedZookeeperApplicationTests {
	...
	@Container
	static KafkaContainer kafka = new ToxicKafkaWithEmbeddedZookeeperContainer("confluentinc/cp-kafka:7.4.0")
